...
from timm.models.layers import Conv2dSame, Linear, BatchNormAct2d, StdConv2dSame
...
def build_model_with_cfg(
    ...
    #     preact=False, stem_type="same", conv_layer=conv_layer)
    # backbone = HybridEmbed(backbone, img_size=384, patch_size=1)
